...
public class Transcaribe extends javax.swing.JFrame {
   ...
   int xMouse,yMouse;
    public Transcaribe() {
        ...
        //simular el recorrido del transca
    ...
    private void initComponents() {
        ...
        fondoL.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/menutranscaribe.png"))); // NOI18N
    ...
    private void mapagenral1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mapagenral1ActionPerformed
        ...
        MapaGeneralFrame2 mapaGeneralFrame2 = new MapaGeneralFrame2();
        mapaGeneralFrame2.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Transcaribe.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Transcaribe().setVisible(true);
            }
        });
    }
    ...
    private EventWaypoint getEvent() {
        return new EventWaypoint() {
            ...
            public void selected(MyWaypoint waypoint) {
                JOptionPane.showMessageDialog(Transcaribe.this, waypoint.getName());
            }
        };
    }
    ...
    TimerTask tarea = new TimerTask() {
            ...
            @Override
            public void run() {
               addWaypoint(new MyWaypoint("T101", event, new GeoPosition(l, ln)));
                ln-=0.0000090;
                l+=0.00000044;  
               addWaypoint(new MyWaypoint("X101", event, new GeoPosition(r, rn))); 
               rn+=0.0000075;
               r+=0.00000104;
               addWaypoint(new MyWaypoint("T102", event, new GeoPosition(t12, t12n)));
               t12n-=0.0000090;
               t12+=0.00000044; 
...
class MapaGeneralFrame2 extends JFrame {
    public MapaGeneralFrame2() {
        initComponents();
